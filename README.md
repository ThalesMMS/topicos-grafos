...
Seminário revisado: **113 slides, 80 minutos de orçamento, quatro integrantes**.
Cinco questões originais (três ENADE e duas POSCOMP), passos de algoritmos com
grafos em estilo manuscrito, comparação visual de heurísticas, Welsh–Powell e três artigos sobre logística,
compiladores e química. A duração real depende do ensaio; os slides de passo
